...
import net.mcreator.kaczka.world.features.StructureFeature;
...
public class KaczkaMod {
	...
	public KaczkaMod() {
		...
		KaczkaModTabs.REGISTRY.register(bus);

		StructureFeature.REGISTRY.register(bus);

		KaczkaModParticleTypes.REGISTRY.register(bus);

		KaczkaModMenus.REGISTRY.register(bus);
		KaczkaModFluids.REGISTRY.register(bus);
		KaczkaModFluidTypes.REGISTRY.register(bus);
