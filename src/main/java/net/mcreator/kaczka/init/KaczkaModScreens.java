...
public class KaczkaModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			MenuScreens.register(KaczkaModMenus.DEPTH_EXTRACTOR_INTERFACE.get(), DepthExtractorInterfaceScreen::new);
			MenuScreens.register(KaczkaModMenus.DUSTYCRAFTING.get(), DustycraftingScreen::new);
		});
	}
}
