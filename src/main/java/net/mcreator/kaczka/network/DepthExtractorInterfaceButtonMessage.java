...
public class DepthExtractorInterfaceButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		KaczkaMod.addNetworkMessage(DepthExtractorInterfaceButtonMessage.class, DepthExtractorInterfaceButtonMessage::buffer, DepthExtractorInterfaceButtonMessage::new, DepthExtractorInterfaceButtonMessage::handler);
	}
}
